<template>
  <div class="mixed-top-menu">
    ...
    <el-scrollbar ref="scrollbarRef" wrap-class="scrollbar-wrapper" :horizontal="true" @scroll="handleScroll">
      <div class="scroll-bar">
        <template v-for="item in list" :key="item.meta.title">
          <div class="item" :class="{ active: isActive(item) }" @click="toPage(item)" v-if="!item.meta.isHide">
