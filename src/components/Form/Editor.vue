...
const overrideIcon = () => {
  setTimeout(() => {
    ...
    const icon4 = document.querySelector(
      `button[data-menu-key="group-more-style"]`
    );
    ...
    const icon7 = document.querySelector(
      `button[data-menu-key="bulletedList"]`
    );
    if (icon7) icon7.innerHTML = "<i class='iconfont-sys'>&#xe64e;</i>";

    const icon8 = document.querySelector(
      `button[data-menu-key="numberedList"]`
    );
    ...
    const icon10 = document.querySelector(
      `button[data-menu-key="group-justify"]`
    );
    if (icon10) icon10.innerHTML = "<i class='iconfont-sys'>&#xe67e;</i>";

    const icon11 = document.querySelector(
      `button[data-menu-key="group-indent"]`
    );
    ...
    const icon14 = document.querySelector(
      `button[data-menu-key="group-image"]`
    );
    if (icon14) icon14.innerHTML = "<i class='iconfont-sys'>&#xe634;</i>";

    const icon15 = document.querySelector(
      `button[data-menu-key="insertTable"]`
    );
    ...
    const icon21 = document.querySelector(
